...
## 
golem::fill_desc(
  pkg_name = "tableauphenologie", # The Name of the package containing the App 
  ...
  repo_url = "https://github.com/ReseauBiodiversiteQuebec/tableauphenologie" # The URL of the GitHub Repo (optional) 
)     
